import { BarChart3, Building2, Radio, Users, Package, MapPin, TrendingUp, Settings, Upload } from 'lucide-react';
      ...
      {!collapsed && uploadMeta && (
        <SidebarFooter className="px-4 py-3 border-t border-border">
          <p className="text-[10px] text-muted-foreground/60">
            Fonte: {uploadMeta.fileName}
          </p>
          <p className="text-[10px] text-muted-foreground/60">
            {uploadMeta.rowCount.toLocaleString('pt-BR')} linhas | {uploadMeta.uploadedAt.toLocaleDateString('pt-BR')} {uploadMeta.uploadedAt.toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}
          </p>
        </SidebarFooter>
      )}
    </Sidebar>
